...
export default function RegisterDialog({ isOpen, onClose, isPublisher = false }) {
    ...
    try {
      const response = await fetch("http://your-api-url/register", {
        ...
        body: JSON.stringify({
          ...
          email,
          password,
          role_id: isPublisher ? 2 : 4, // 2 for publisher, 4 for normal user
        }),
      })
          ...
          >
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
                {isPublisher ? "Publisher Registration" : "User Registration"}
              </h2>
              <button
                onClick={onClose}
